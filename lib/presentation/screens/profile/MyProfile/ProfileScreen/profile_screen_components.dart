                          ...
                          return InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AllActivityListMyProfile(
                                        profileData: profileData, myActivities: UserBloc.myActivities)),
                              );
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            String hobbyDateRange(index) {
                                              DateTime _startDate = DateTime(
                                                  int.parse(profileData.hobbies[index].split("%")[2]),
                                                  monthToInt(profileData.hobbies[index].split("%")[1]));
                                              DateTime _finishDate = profileData.hobbies[index].split("%").length == 3
                                                  ? DateTime.now()
                                                  : DateTime(int.parse(profileData.hobbies[index].split("%")[4]),
                                            ...
                                            String? _hobbyFinishYear =
                                                UserBloc.user!.hobbies[index].split("%").length == 3
                                                    ? null
                                                    : UserBloc.user!.hobbies[index].split("%")[4];
                                            String? _hobbyFinishMonth =
                                                UserBloc.user!.hobbies[index].split("%").length == 3
                                                    ? null
                                                    : UserBloc.user!.hobbies[index].split("%")[3];
                                                  ...
                                                  : Stack(
                                                      children: [
                                                        Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                              ...
                                                              border: Border.all(
                                                                width: 1,
                                                                color:
                                                                    _mode.search_peoples_scaffold_background() as Color,
                                                              )),
                                                          child: CircleAvatar(
                                                            backgroundColor: Color(0xFF0353EF),
                                                        ...
                                                        Container(
                                                            ...
                                                            child: hobbyItem(
                                                                0, profileData.hobbies[index].split("%").first)),
                                                      ],
                                                    ),
                                              title: Text(_hobbyName,
                                                  textScaleFactor: 1,
                                                  style: GoogleFonts.rubik(color: Mode().blackAndWhiteConversion())),
                                              subtitle: Text(
                                                ...
                                                textScaleFactor: 1,
                                                style: GoogleFonts.rubik(
                                                    color: _mode.blackAndWhiteConversion(), fontSize: 14),
                                              ),
                                            );
                                          });
                                    });
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    hint: Text(
                                        selectedFinishYear == null
                                            ? "Bıraktığınız yılı seçin"
                                            : selectedFinishYear.toString(),
                                        textScaleFactor: 1,
                                        style: GoogleFonts.rubik(color: Mode().blackAndWhiteConversion())),
                                    items: List.generate(60, (index) {
                                      return (1962 + index).toString();
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    hint: Text(
                                        selectedFinishMonth == null
                                            ? "Bıraktığınız ayı seçin"
                                            : selectedFinishMonth.toString(),
                                        textScaleFactor: 1,
                                        style: GoogleFonts.rubik(color: Mode().blackAndWhiteConversion())),
                                    items: <String>[
                                      "Ocak",
                          ...
                          TextButton(
                              onPressed: () {
                                  ...
                                  if (selectedStartYear != null && selectedStartMonth != null) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      customSnackBar(
                                          ...
                                          bgColor: Mode.isEnableDarkMode == true
                                              ? Color(0xFF0353EF)
                                              : const Color(0xFF000B21)),
                                    );
                                ...
                                if (isChecked == true &&
                                    ...
                                    selectedStartYear != null &&
                                    selectedStartMonth != null) {
                                  addHobbyWithJustStartDate(
                                      context, selectedHobbyName, selectedStartYear, selectedStartMonth);
                                  ...
                                  if (selectedStartYear != null &&
                                    ...
                                    selectedFinishYear != null &&
                                    selectedFinishMonth != null) {
                                  addHobbyWithStartAndFinishDate(context, selectedHobbyName, selectedStartYear,
                                      selectedStartMonth, selectedFinishYear, selectedFinishMonth);
                  ...
                  return StatefulBuilder(builder: (context, setStateEditHobbyBottomSheet) {
                    return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String? _hobbyStartYear = UserBloc.user!.hobbies[index].split("%")[2];
                          String? _hobbyStartMonth = UserBloc.user!.hobbies[index].split("%")[1];
                          String? _hobbyFinishYear = UserBloc.user!.hobbies[index].split("%").length == 3
                              ? null
                              : UserBloc.user!.hobbies[index].split("%")[4];
                          String? _hobbyFinishMonth = UserBloc.user!.hobbies[index].split("%").length == 3
                              ? null
                              : UserBloc.user!.hobbies[index].split("%")[3];
