  ...
  ListView _showSavedUsers(Size _size) {
    ...
    return _size.width < 335
        ...
        : ListView.builder(
            ...
            controller: _searchPeopleListController,
            itemCount:
                (_savedBlocUsersLength % 2 == 0 ? _savedBlocUsersLength / 2 : ((_savedBlocUsersLength - 1) / 2) + 1)
                    .toInt(),
            itemBuilder: (
              BuildContext context,
              int index,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _savedBlocUsersLength % 2 == 0
                        ...
                        : (_savedBlocUsersLength % 2 == 0
                                    ? _savedBlocUsersLength / 2
                                    : (_savedBlocUsersLength - 1) / 2) ==
                                index
                            ? const Expanded(
                                flex: 1,
                                child: SizedBox(),
              ...
              child: InkWell(
                onTap: () {
                  setState(() {
                    ...
                    _savedBloc.allRequestList
                        .removeWhere((element) => element.userID == _savedBloc.allRequestList[index].userID);
                  });
                },
                child: Container(
